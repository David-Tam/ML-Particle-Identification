...
For example, for the electromagnetic transition of an excited argon-36 (from 2+
 1 level to 0g.s +
 level), its
transition rate, τ can be expressed as:

where T2+→0+
 1
 g.s
 is the excited argon-36’s lifetime at 2+
 1 level, ω is the angular frequency of the γ-ray emitted
during the transition, and B(E2; 2+
 →
 0
+
 )
 represents
 the reduced matrix element that contains information
1
 g.s
of the excited argon-36 nuclear wavefunction.
