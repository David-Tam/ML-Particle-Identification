...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.6\textheight]{36Ar_reaction} \end{center}


\begin{center}\includegraphics[width=0.8\linewidth,height=0.8\textheight]{37Ar_reaction} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.6\textheight]{TIP_labelled} \end{center}
...
\includegraphics[width=1\linewidth,height=1\textheight]{sumECal} 
...
\begin{center}\includegraphics{proj3_DavidT_files/figure-latex/rd_plt-1} \end{center}
...
\begin{center}\includegraphics{proj3_DavidT_files/figure-latex/rd_plt1-1} \end{center}

We can further look at the relative importance of the variables:


\begin{center}\includegraphics{proj3_DavidT_files/figure-latex/rd_plt2-1} \end{center}
